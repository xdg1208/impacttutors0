  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      <div className="space-y-1">
        ...
        <p className="text-muted text-sm">Manage your tutor account security and preferences.</p>
      </div>
        ...
        <div className="space-y-6">
          <div className="premium-card rounded-2xl p-6 bg-primary/5 border-primary/10">
            ...
            <p className="text-xs leading-relaxed text-primary/70">
              Keep your tutor credentials secure. Change your password regularly to maintain the integrity of your classroom sessions.
            </p>
          </div>
        </div>
      </div>
